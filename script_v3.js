    ...
    methods: {
        ...
        buyItem(){
            ...
            if(item.currency === "Neo Stone") {
                this.SHARED_characters[charIndex].currentStones = Math.max(this.SHARED_characters[charIndex].currentStones - (item.cost * amount), 0)
            }

            if(item.currency === "Neo Gem") {
                this.SHARED_characters[charIndex].currentGems = Math.max(this.SHARED_characters[charIndex].currentGems - (item.cost * amount), 0)
            }
